  ...
  function onData (data) {
    ...
    if (typeof data === 'string') {
      ...
      if (data instanceof Buffer) {
        console.error(`data argument is NOT a Buffer but ${data} instead when isBinary is ${isBinary}`);
      }
      if (chunks instanceof Buffer) {
        console.error(`chunks argument is NOT a Buffer but ${chunks} instead when isBinary is ${isBinary}`);
      }
    ...
    if (contentLength > self.maxHttpBufferSize) {
      console.log(`maxHttpBufferSize (${self.maxHttpBufferSize}) exceeded`);
      chunks = '';
